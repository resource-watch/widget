...
class WidgetValidator {
    ...
    static isString(val)  { return typeof val === "string" ? true : false; }
    static isBoolean(val) { return typeof val === "boolean" ? true : false; }
    static isArray(val)   { return val instanceof Array; }
    static isObject(val)  { return (val instanceof Object && !(val instanceof Array)); }
